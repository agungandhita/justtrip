    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-2 text-sm text-gray-500 mb-4">
                ...
                <span>Hasil untuk "{{ $destinasi }}"</span>
            </div>
            ...
            <div class="mb-8">
                <div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-green-800">Paket Wisata Tersedia!</h2>
                            <p class="text-green-700">Kami menemukan {{ $layananTersedia->count() }} paket wisata yang sesuai dengan pencarian Anda.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                            @if($layanan->gambar_destinasi)
                                ...
                                @if($gambar && is_array($gambar) && count($gambar) > 0)
                                     <img src="{{ asset('storage/' . $gambar[0]) }}" alt="{{ $layanan->nama_layanan }}" class="w-full h-48 object-cover">
                                 @else
                            ...
                            <div class="p-6">
                                <h3 class="font-bold text-lg text-gray-800 mb-2">{{ $layanan->nama_layanan }}</h3>
                                <p class="text-gray-600 text-sm mb-3 line-clamp-2">{{ Str::limit($layanan->deskripsi, 100) }}</p>
            ...
            <div class="mb-8">
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-yellow-800">Paket Belum Tersedia</h2>
                            <p class="text-yellow-700">Maaf, kami belum memiliki paket wisata untuk destinasi "{{ $destinasi }}". Tapi jangan khawatir!</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <div class="text-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Buat Permintaan Khusus</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-8">
                <div class="space-y-4">
                    <h3 class="font-bold text-gray-800">Keuntungan Custom Request:</h3>
                    <ul class="space-y-2">
                        <li class="flex items-center text-gray-600">
                            <i class="fas fa-check text-green-500 mr-3"></i>
                            Itinerary disesuaikan dengan keinginan
                        </li>
                        <li class="flex items-center text-gray-600">
                            <i class="fas fa-check text-green-500 mr-3"></i>
                        ...
                        <li class="flex items-center text-gray-600">
                            <i class="fas fa-check text-green-500 mr-3"></i>
                            Tanggal keberangkatan bebas
                        </li>
                        <li class="flex items-center text-gray-600">
                            <i class="fas fa-check text-green-500 mr-3"></i>
                            Konsultasi gratis dengan travel expert
                        </li>
                    </ul>
                </div>
                
                <div class="space-y-4">
                    <h3 class="font-bold text-gray-800">Proses Custom Request:</h3>
                    <div class="space-y-3">
            ...
            <div class="text-center">
                <a href="{{ route('guest-booking.form', ['destinasi' => $destinasi, 'is_custom' => true]) }}" 
                   class="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-4 px-8 rounded-xl text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200">
