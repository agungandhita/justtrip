    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <p class="text-gray-300 mb-6 leading-relaxed max-w-md">
                    Liburan jadi gampang, cukup sekali klik dengan JustTrip. Kami berkomitmen memberikan pengalaman perjalanan terbaik untuk semua traveler.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="#destinations" class="text-gray-300 hover:text-white transition-colors duration-200 flex items-center">
                    ...
                    <li>
                        <a href="#packages" class="text-gray-300 hover:text-white transition-colors duration-200 flex items-center">
                            <i class="fas fa-suitcase-rolling w-4 mr-3"></i>
                            Paket Tour
                        </a>
                    </li>
                    <li>
        ...
        <div class="border-t border-white/10 mt-8 pt-8 text-center">
            <p class="text-gray-400 text-sm">
                © {{ date('Y') }} JustTrip. All rights reserved. Made with ❤️ for travelers.
            </p>
        </div>
    </div>
</footer>
