        ...
        <div class="mb-8 px-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 pl-11">Tambah layanan travel baru</p>
                </div>
                ...
                <form action="{{ route('admin.layanan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="durasi_hari" name="durasi_hari" value="{{ old('durasi_hari') }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="lokasi_tujuan" name="lokasi_tujuan" value="{{ old('lokasi_tujuan') }}"
                                   ...
                                   placeholder="Contoh: Bali, Jakarta, Yogyakarta" required>
                            @error('lokasi_tujuan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div id="fasilitas-container">
                                <div class="fasilitas-item flex items-center gap-2 mb-2">
                                    <input type="text" name="fasilitas[]" value="{{ old('fasilitas.0') }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="4"
                                      ...
                                      placeholder="Masukkan deskripsi layanan travel" required>{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-indigo-400 transition-colors duration-200">
                                ...
                                <div id="upload-area" class="cursor-pointer" onclick="document.getElementById('gambar_destinasi').click()">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">Klik untuk upload gambar atau drag & drop</p>
