            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h1 class="text-3xl font-bold text-gray-800 mb-0">Special Offers Management</h1>
                    </div>
                    <p class="text-gray-600 pl-11">Manage special offers and promotions</p>
                </div>
        ...
        <div class="px-4 mb-6">
            <div class="bg-white rounded-xl shadow-md p-6">
                <form method="GET" action="{{ route('admin.special-offers.index') }}" class="flex flex-col md:flex-row gap-4">
                    <div class="flex-1">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search offer title or description..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Offer</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Discount</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Valid Period</th>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500">to {{ $item->end_date->format('M d, Y') }}</div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('admin.special-offers.show', $item) }}" class="text-indigo-600 hover:text-indigo-900 p-1 rounded" title="View Details">
                                            ...
                                            <form action="{{ route('admin.special-offers.destroy', $item) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this special offer?')">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-lg font-medium">No special offers found</p>
                                            <p class="text-sm">Please add new special offers or change search filters</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
