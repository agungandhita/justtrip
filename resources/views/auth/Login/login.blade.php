        ...
        <div class="max-w-md w-full">
            ...
            <div class="p-8 rounded-2xl bg-white/90 backdrop-blur-sm shadow-xl border border-white/20">
                ...
                <p class="text-gray-800 text-sm !mt-8 text-center">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 ml-1 whitespace-nowrap font-semibold transition-all duration-300">
                        Daftar disini
                    </a>
                </p>
            </div>
