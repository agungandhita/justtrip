...
class LayananSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $jenisLayanan = [
            'paket_wisata', 'tour_domestik', 'tour_internasional', 'honeymoon',
            'family_trip', 'adventure', 'cultural_tour', 'business_trip',
            'pilgrimage', 'cruise', 'backpacker', 'luxury_tour'
        ];
        ...
        for ($i = 0; $i < 50; $i++) {
            ...
            Layanan::create([
                'nama_layanan' => $this->generateLayananName($jenis, $destination, $durasi),
                'jenis_layanan' => $jenis,
    ...
    private function generateLayananName($jenis, $destination, $durasi)
    {
        $names = [
            ...
            'tour_domestik' => 'Tour Domestik ' . $destination,
            ...
            'adventure' => 'Adventure Tour ' . $destination,
            'cultural_tour' => 'Cultural Tour ' . $destination,
            'business_trip' => 'Business Trip ' . $destination,
            'pilgrimage' => 'Pilgrimage Tour ' . $destination,
            'cruise' => 'Cruise Package ' . $destination,
            'backpacker' => 'Backpacker Tour ' . $destination,
            'luxury_tour' => 'Luxury Tour ' . $destination
        ];
